   ...
   function getFromLDAP($ldap_connection, array $ldap_method, $userdn, $login, $import = true) {
      ...
      if (is_resource($ldap_connection)) {
         ...
         foreach ($fields as $k => $e) {
		  ...
		  case "usercategories_id" :
# FEMTO-ST 2018 Laurent STECK ## DEBUT définit département comme catégorie
...
"10"=>"ENERGIE");
                     ...
                     $this->fields[$k] = Dropdown::importExternal('UserCategory',$femto_dept[$val]);
# FEMTO-ST 2018 Laurent STECK ## FIN définit département comme catégorie
