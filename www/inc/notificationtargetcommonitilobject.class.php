...
# FEMTO-ST 20122018 Laurent STECK ## balise pour définir l'url vers le ticket en profil post only : 1 ##
      $data["##$objettype.urlpostonly##"]
                        = $this->formatURL($options['additionnaloption']['usertype'],
                                           $objettype."_".$item->getField("id")."__1");

# FEMTO-ST 20122018 Laurent STECK ## FIN balise pour définir l'url vers le ticket en profil post only : 1 ##
...
# FEMTO-ST 20182018 Laurent STECK ## balise pour définir l'url vers le ticket en profil post only : 1 ##
      $data["##$objettype.urlapprovepostonly##"]
                           = $this->formatURL($options['additionnaloption']['usertype'],
                                              $objettype."_".$item->getField("id")."__1"."_".
                                                        $item->getType().$tab);

# FEMTO-ST 20182018 Laurent STECK ## FIN balise pour définir l'url vers le ticket en profil post only : 1 ##
      ...
      if ($item->countUsers(CommonITILActor::REQUESTER)) {
         ...
         foreach ($item->getUsers(CommonITILActor::REQUESTER) as $tmpusr) {
	       ...
	       # FEMTO-ST 2018 Laurent STECK ## DEBUT définit département dans le sujet du ticket
	       #
	                     $userCategory = $user_tmp->getField('usercategories_id');

     $query = "SELECT name FROM glpi_usercategories ".
         ...
         if ($DB->numrows($result)==1) {
            ...
            switch($ligne['name']) {
               case 1:
                  ...
                  break;
               case 2:
                  $tmp["##author.dept##"] = "AS2M";
                  break;
               case 3:
                  $tmp["##author.dept##"] = "Mécanique Appliquée";
                  break;
               case 5:
                  $tmp["##author.dept##"] = "MN2S";
                  break;
               case 6:
                  $tmp["##author.dept##"] = "OPTIQUE";
                  break;
               case 7:
                  $tmp["##author.dept##"] = "DISC";
                  break;
               case 8:
                  $tmp["##author.dept##"] = "COMMUN";
                  break;
               case 10:
                  $tmp["##author.dept##"] = "ENERGIE";
                  break;
               default:
                  $tmp["##author.dept##"] = $ligne['name'];
                  break;
	       ...
	       # FEMTO-ST 2018 Laurent STECK ## FIN définit département dans le sujet du ticket
...
# FEMTO-ST 2018 Laurent STECK ## ## DEBUT ## balise pour définir l'url vers le ticket en profil post only : 1 ##

                    #'author.dept'                       => $LANG['job'][73],
                    'author.dept'                       => __('Departement'),
# FEMTO-ST 2018 Laurent STECK ## ## FIN ## balise pour définir l'url vers le ticket en profil post only : 1 ##
