...
class Auth extends CommonGLPI {
   ...
   */
   ...
   static function redirectIfAuthenticated($redirect = null) {
      ...
      ## FEMTO-ST 2017-10-23 Laurent Steck ## DEBUT ## Mise en commentaire de la redirection d'origine

      if (Session::getCurrentInterface() == "helpdesk") {
         if ($_SESSION['glpiactiveprofile']['create_ticket_on_login']) {
      // Html::redirect($CFG_GLPI['root_doc'] . "/front/helpdesk.public.php?create_ticket=1");
      // // on renvoie cers la page de choix de l'entité (service commun)
...
## FEMTO-ST 2017-10-23 Laurent Steck ## FIN ## Mise en commentaire de la redirection d'origine
