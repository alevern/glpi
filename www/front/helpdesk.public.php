...
if (isset($_POST['newprofile'])) {
 ...
 ## FEMTO-ST 2018-10-10 Tristan Cardot ## INLINE DEBUT ## newprofile 1 => post-only
 ...
 ## FEMTO-ST 2018-10-10 Tristan Cardot ## INLINE FIN ## newprofile 1 => post-only
   } else {
...
## FEMTO-ST 2018-11-07 Tristan Cardot ## INLINE ## modification du comportement de la redirection.
   if (!Session::changeActiveEntities($_GET["active_entity"], $_GET["is_recursive"])) {
	   if ($_GET["active_entity"] == $_SESSION["glpiactive_entity"] 
		   ...
		   ## FEMTO-ST 2017-10-23 Laurent Steck ## on ne passe pas à la page parent
...
if (isset($_GET['create_ticket'])) {
   ## FEMTO-ST 2019-02-06 Tristan Cardot ## START ## Redirection en cas de création de ticket sur l'entité racine. 
   if ($_SESSION['glpiactive_entity'] == 0 ## 0 = Entité racine
   || !isset($_GET['active_entity']) ## ne provient pas de selectEntity
   && $_SESSION['glpiactiveprofile']['id'] == 1) { ##profile post only
      Html::redirect($CFG_GLPI['root_doc']."/front/selectEntity.php");
   }
   ## FEMTO-ST 2018-02.06 Tristan Cardot ## END ## Redirection en cas de création de ticket sur l'entité racine. 
