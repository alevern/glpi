...
if ($report->criteriasValidated()) {
   ...
   $report->setColumns(array( 'id' => "Ticket", 'categorie' => 'Catégorie', 'demandeur' => 'Demandeur', 'technicien' => "Intervenant", 
        'statut' => "Statut", 'ouvert' => "Ouvert", 'echeance' => "EchÃ©ance", 'ferme' => "FermÃ©",
        'delaiPriseEnCompte' => "DÃ©lai prise en compte", 'delaiResolution' => "Délai de résolution", 'delaifermeture' => "DÃ©lai fermeture", 'tempsTraitement' => "Temps traitement" ) ); 
