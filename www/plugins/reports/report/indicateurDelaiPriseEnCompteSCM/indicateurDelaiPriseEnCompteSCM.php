...
$report = new PluginReportsAutoReport(__('indicateurDelaiPriseEnCompteSCM_report_title', 'reports'));
...
if ($report->criteriasValidated()) {
  echo "<table class='tab_cadrehov' cellpadding='5'>";
   echo "<tr><td><th> Rapport sur le nombre de tickets pris en compte après le dÃ©lai de 5 jours</th></td></tr>";
   echo "</table>";
   echo "<br><br>";
