...
if ($report->criteriasValidated()) {
   ...
   echo "<tr><td><th><center> Rapport sur le nombre de tickets COMMUNICATION du d&eacute;partement AS2M </center></th></td></tr>";
   echo "</table>";
   echo "<br><br>";
...
// echo "$query<br>";
// $datedebut = substr($query,106,19);
// $datefin = substr($query,155,19);
