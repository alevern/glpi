...
if ($report->criteriasValidated()) {
   ...
   echo "<tr><td><th> Rapport sur le nombre de tickets pris en compte apr̬s le d̩lai de 5 jours</th></td></tr>";
   echo "</table>";
   echo "<br><br>";
...
// echo $query;
   ...
   if($DB->numrows($res1) > 0) {
      ...
      echo "<tr><td><th> Nombre de tickets pris en compte apr̬s 5 jours</th></td>".
      ...
      if($DB->numrows($res2) > 0) {
         ...
         echo "<tr><td><th>No ticket</th></td><td><th>Ouvert</th></td>".
              ...
              "<td><th>D̩lai prise en compte en jours</th></td></tr>";
