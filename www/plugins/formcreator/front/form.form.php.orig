...
if (isset($_POST['add'])) {
   ...
   if (strpos($_SERVER['HTTP_REFERER'], 'formdisplay.php') !== false) {
    ...
    ##FEMTO-ST 2020-12 L STECK ## DEBUT ## on redirige vers tracking_injector.php
     // Html::redirect('formlist.php');
     Html::redirect($CFG_GLPI["root_doc"]."/front/tracking.injector.php");
     ##FEMTO-ST 2022-12 L STECK ## FIN ## on redirige vers tracking_injector.php
